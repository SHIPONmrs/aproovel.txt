...
def chk(): 
  ...
  print ("\033[1;92m╰────────────────────────────────────────────╯")
  try: 
    plr = requests.get("https://github.com/SHIPONmrs/aproovel/tree/main").text 
    if id in httpCaht: 
      print("\x1b[1;97m [\033[1;92m•\x1b[1;97m]\033[1;97m WELCOME TO THE SHIPON TOOLS YOUR ID IS ACTIVE........\033[97m") 
      msg = str(os.geteuid()) 
      time.sleep(1) 
      pass 
    else: 
